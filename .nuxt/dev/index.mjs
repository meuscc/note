import 'file://D:/Wss/meuscc/notes/node_modules/unenv/runtime/polyfill/fetch.node.mjs';
...
import { toEventHandler, defineEventHandler, handleCacheHeaders, createEvent, createApp, createRouter, lazyEventHandler, eventHandler, useQuery } from 'file://D:/Wss/meuscc/notes/node_modules/h3/dist/index.mjs';
...
import { withQuery, joinURL } from 'file://D:/Wss/meuscc/notes/node_modules/ufo/dist/index.mjs';
...
import { renderToString as renderToString$2 } from 'file://D:/Wss/meuscc/notes/node_modules/vue/server-renderer/index.mjs';
...
storage.mount('root', _unstorage_drivers_fs({"driver":"fs","base":"D:/Wss/meuscc/notes"}));
storage.mount('src', _unstorage_drivers_fs({"driver":"fs","base":"D:/Wss/meuscc/notes/server"}));
storage.mount('build', _unstorage_drivers_fs({"driver":"fs","base":"D:/Wss/meuscc/notes/.nuxt"}));
storage.mount('cache', _unstorage_drivers_fs({"driver":"fs","base":"D:/Wss/meuscc/notes/.nuxt/cache"}));
...
const _67ba03 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _67ba03, lazy: true, method: undefined },
  { route: '/**', handler: _67ba03, lazy: true, method: undefined }
];
...
const getClientManifest = cachedImport(() => import('file://D:/Wss/meuscc/notes/.nuxt/dist/server/client.manifest.mjs'));
const getSSRApp = !process.env.NUXT_NO_SSR && cachedImport(() => import('file://D:/Wss/meuscc/notes/.nuxt/dist/server/server.mjs'));
